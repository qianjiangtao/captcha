 ...
 * </pre>
 * <p>
 * Note that the <code>build()</code> must always be called last. Other methods
 * are optional, and can sometimes be repeated. For example:
 * </p>
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * Adding multiple backgrounds has no affect; the last background added will
 * simply be the one that is eventually rendered.
 * </p>
 * <p>
...
public final class Captcha implements Serializable {
	...
	public static class Builder implements Serializable {
		...
		/**
		 * Add a background using the default {@link BackgroundProducer} (a
		...
		/**
		 * Add noise using the default {@link NoiseProducer} (a
		...
		public Builder addNoise(List<NoiseProducer> listNprod) {
			if (listNprod != null) {
				for (NoiseProducer nProd : listNprod) {
					nProd.makeNoise(_img);
				}
			}
			return this;
		...
		/**
		 * Gimp the image using the default {@link GimpyRenderer} (a
		 * {@link RippleGimpyRenderer}).
		 */
		public Builder gimp() {
		...
		public Builder gimp(List<GimpyRenderer> gimpyList) {
			if (gimpyList != null) {
				for (GimpyRenderer gimpy : gimpyList) {
					gimpy.gimp(_img);
				}
			}
			return this;
		...
		/**
		 * Build the CAPTCHA. This method should always be called, and should
